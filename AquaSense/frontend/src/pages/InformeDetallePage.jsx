...
const InformeDetallePage = () => {
    ...
    if (!informe)
        return <div className="detalle-informe-container"><Navbar /><p style={{ padding: 20 }}>Cargando informe...</p></div>;
    return (<div className="detalle-informe-container">
      ...
      <div className="detalle-box">
        ...
        <div className="botones">
          {informe.fileUrl && (<a href={informe.fileUrl} download className="btn-descargar">
              Descargar PDF
            </a>)}
        </div>
        ...
        {informe.fileUrl && (<div className="pdf-preview">
            <h3>Vista previa del informe</h3>
            <iframe src={informe.fileUrl} title="Vista previa del PDF" width="100%" height="500px" style={{ border: 'none' }}/>
          </div>)}
      </div>
    </div>);
};
