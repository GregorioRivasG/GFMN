...
const PerfilPage: React.FC = () => {
  ...
  if (loading) return <div className="perfil-container"><Navbar /><div className="loading">Cargando...</div></div>;
  if (error) return <div className="perfil-container"><Navbar /><div className="error">Error: {error}</div></div>;
