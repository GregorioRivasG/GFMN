...
const DashboardPage = () => {
    ...
    useEffect(() => {
        const fetchTanks = async () => {
            try {
                ...
                const response = await fetch(' http://45.174.90.242:5000/api/tanks', {
                    headers: {
    ...
    if (loading)
        return <div className="dashboard-container"><Navbar /><p style={{ padding: 20 }}>Cargando...</p></div>;
    if (error)
        return <div className="dashboard-container"><Navbar /><p style={{ padding: 20 }}>Error: {error}</p></div>;
    return (<div className="dashboard-container">
      ...
      <div className="dashboard-content">
        ...
        <table>
          ...
          <tbody>
            {tanks.map((tank) => (<tr key={tank._id}>
